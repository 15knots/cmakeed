...
public class CMakeFileNewWizard extends Wizard implements INewWizard {
	private CMakeFileNewWizardPage page;
	private ISelection selection;

	/**
	 * Constructor for CMakeFileNewWizard.
	 */
	public CMakeFileNewWizard() {
		super();
	...
	public void addPages() {
		page = new CMakeFileNewWizardPage(selection);
		addPage(page);
	}
