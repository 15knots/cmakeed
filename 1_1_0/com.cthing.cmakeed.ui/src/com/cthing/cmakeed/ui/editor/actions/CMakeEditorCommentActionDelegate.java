 ...
 * 
 */
public class CMakeEditorCommentActionDelegate implements IEditorActionDelegate, IWorkbenchWindowActionDelegate {
    ...
    public void run(final IAction action) {
        ...
        if (currentSelection instanceof ITextSelection) {
            ...
            try {
                ...
                // Get everything in the document up to the beginning of the
                // line of first line of the selection
                final StringBuilder sb = new StringBuilder(document.get().substring(0, begin));
                // Get the actual selected text by full lines, including the new
                // line chars at the end of each line
                ...
                ITextSelection endSelection = new TextSelection(selection.getOffset(), selection.getLength() + charsAdded);
