...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template
    match="/document/section/paragraph//literal[not(@*)] | /document/section/definition_list//literal[not(@*)] | /document/section/section/definition_list//literal[not(@*)] | /document/section/section/section/definition_list//literal[not(@*)] | /document/section/section/paragraph//literal[not(@*)]">
